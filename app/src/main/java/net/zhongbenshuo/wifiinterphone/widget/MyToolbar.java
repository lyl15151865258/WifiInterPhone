package net.zhongbenshuo.wifiinterphone.widget;
...
public class MyToolbar extends Toolbar {
    ...
    public void initToolBar(AppCompatActivity appCompatActivity, MyToolbar toolbar, String title, int leftImage, int rightImage, View.OnClickListener onClickListener) {
    ...
    public void initToolBar(AppCompatActivity appCompatActivity, MyToolbar toolbar, String title, int leftImage, View.OnClickListener onClickListener) {
        initToolBar(appCompatActivity, toolbar, title, leftImage, -1, onClickListener);
    }

    public void initToolBar(AppCompatActivity appCompatActivity, MyToolbar toolbar, String title, View.OnClickListener onClickListener) {
